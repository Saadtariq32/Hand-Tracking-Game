...
cookie_size = int(screen_h * 0.1)
fly_size = int(screen_h * 0.15)
...
class HUD(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.end_text = ""
        self.font_main = QtGui.QFont("Comic Sans MS", 40, QtGui.QFont.Bold)
    ...
    def paintEvent(self, event):
        ...
        self.draw_text(painter, "Grab A Cookie!", screen_w // 2 - 250, int(bar_height * 0.75),
                       QtGui.QColor(60, 20, 200), self.font_main)
